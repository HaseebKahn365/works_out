      ...
      child: LineChart(
        LineChartData(
            ...
            titlesData: FlTitlesData(
              //label the bottom axis with the days of the week
              //and the left axis with the number of pushups
              show: true,
            ...
            gridData: FlGridData(
              ...
              getDrawingVerticalLine: (value) {
                return FlLine(
                  color: Theme.of(context).colorScheme.onSecondaryContainer.withOpacity(0.02),
                  strokeWidth: 1,
                );
              },
            ),
